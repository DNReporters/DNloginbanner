...
############################################
#        PROJECT: DNloginbanner            #
#        Author: DNReporters               #
#        email: dnreporters14@gmailcom     #
############################################
echo -e "\e[32m[*]\e[34m WELCOME TO DNReporters TOOLS  \e[m "
echo
#Installing the following packages to install DNloginbanner
echo " "
echo -e "\e[32m[*]\e[34m Installing DNloginbanner \e[m "
echo
#storage permission
termux-setup-storage -y && rm -rf DNloginbanner-master
...
echo "
        ...
        WELCOME TO DNReporters TOOLS_-^^DNReporters^^-_ SUBSCRIBE YOUTUBE CHANNEL
...
echo " "
echo "[*]Installing DNloginbanner please wait " |lolcat
sleep 3
...
#change directory to DNloginbanner
cd DNloginbanner
...
echo -e "\033[1;33m[*]system ok -- CHECKED BY DNReporters\e[m "
echo -e "\033[1;33m[*]setting termux as a real hacker \e[m"
echo -e "\033[1;33m[*]Please SUBSCRIBE DNReporters channel for hacking tutorial! \e[m "
echo FINISHED !
echo -e "\033[1;32m                                                             
﹌﹌﹌﹌﹌﹌﹌﹌﹌﹌﹌﹌﹌﹌﹌﹌﹌﹌﹌﹌﹌﹌﹌ \033[m "
sleep 4.0
...
echo -e "\e[32m     
    ...
    SUBSCRIBE DNReporters channel for hacking and cyber security tutorials,ok?
...
tput cup 6 30
echo -e "\x1b[42m DNReporters's DNReporters channel \x1b[m"
tput cup 9 0
...
tput cup 20 0
figlet -f slant "DNReporters's DNReporters" |lolcat
echo " "
echo " "
#done setting up
