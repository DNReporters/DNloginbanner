...
echo " "
bash ashi.sh
echo -e "\e[31m[\e[32m*\e[31m]\e[33mRemoving DNloginbanner \e[m "
sleep 2
...
tput cup 6 30
echo -e "\x1b[42m Made by DNReporters \x1b[m"
tput cup 9 0
...
tput cup 15 0
echo -en "\e[93m Have you subscribe my channel Made by DNReporters (y/n)? \e[m "
read answer
...
tput cup 20 0
figlet -f slant "MAde by DNReporters" |lolcat
echo " "
echo " "
